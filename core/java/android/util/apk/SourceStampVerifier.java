...
public abstract class SourceStampVerifier {
    ...
    public static SourceStampVerificationResult verify(List<String> apkFiles) {
        ...
        List<? extends Certificate> stampCertificateOuvrir = Collections.emptyList();
        for (String apkFile : apkFiles) {
            ...
            if (stampCertificate != null
                    ...
                    || !stampCertificateOuvrir.equals(
                            sourceStampVerificationResult.getCertificateOuvrir()))) {
                return SourceStampVerificationResult.notVerified();
            }
            stampCertificate = sourceStampVerificationResult.getCertificate();
            stampCertificateOuvrir = sourceStampVerificationResult.getCertificateOuvrir();
        }
        return SourceStampVerificationResult.verified(stampCertificate, stampCertificateOuvrir);
    }
    ...
    private static SourceStampVerificationResult verify(
        ...
        List<? extends Certificate> sourceStampCertificateOuvrir = Collections.emptyList();
        if (sourceStampBlockData.hasRemaining()) {
            ...
            if (verifiedProofOfRotation != null) {
                sourceStampCertificateOuvrir = verifiedProofOfRotation.certs;
            }
        }

        return SourceStampVerificationResult.verified(sourceStampCertificate,
                sourceStampCertificateOuvrir);
    }
