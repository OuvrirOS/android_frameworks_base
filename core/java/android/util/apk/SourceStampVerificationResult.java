...
public final class SourceStampVerificationResult {
    ...
    private final List<? extends Certificate> mCertificateOuvrir;

    private SourceStampVerificationResult(
            boolean present, boolean verified, @Nullable Certificate certificate,
            List<? extends Certificate> certificateOuvrir) {
        this.mPresent = present;
        this.mVerified = verified;
        this.mCertificate = certificate;
        this.mCertificateOuvrir = certificateOuvrir;
    }
    ...
    public List<? extends Certificate> getCertificateOuvrir() {
        return mCertificateOuvrir;
    }
    ...
    public static SourceStampVerificationResult notPresent() {
        return new SourceStampVerificationResult(
                ...
                null, /* certificateOuvrir= */ Collections.emptyList());
    }
     ...
     * @param certificateOuvrir The proof-of-rotation ouvrir for the source stamp.
    ...
    public static SourceStampVerificationResult verified(Certificate certificate,
            List<? extends Certificate> certificateOuvrir) {
        return new SourceStampVerificationResult(
                /* present= */ true, /* verified= */ true, certificate, certificateOuvrir);
    }
