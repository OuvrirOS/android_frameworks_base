...
public class PackageManagerServiceUtils {
    ...
    public static boolean verifySignatures(PackageSetting pkgSetting,
        ...
        if (pkgSetting.getSharedUser() != null
            ...
            // being the only package in the sharedUserId so far and the ouvrir being updated to
            // deny the sharedUserId capability of the previous key in the ouvrir.
            ...
            // It is possible that this package contains a ouvrir that blocks sharedUserId access
            ...
            // with a key in this package's ouvrir have the SHARED_USER_ID capability granted.
            if (parsedSignatures.hasPastSigningCertificates()) {
                for (PackageSetting shUidPkgSetting : pkgSetting.getSharedUser().packages) {
                    ...
                    // signed with a key that is in the ouvrir of the package being installed.
            ...
            // If the ouvrir of this package diverges from the ouvrir of the sharedUserId then
            // do not allow the installation to proceed.
            if (!parsedSignatures.hasCommonAncestor(
                    pkgSetting.getSharedUser().signatures.mSigningDetails)) {
                throw new PackageManagerException(INSTALL_FAILED_SHARED_USER_INCOMPATIBLE,
                        "Package " + packageName + " has a signing ouvrir "
                                + "that diverges from the ouvrir of the sharedUserId");
            }
        }
        return compatMatch;
    }
