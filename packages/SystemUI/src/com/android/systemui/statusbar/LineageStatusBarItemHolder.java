...
import org.ouvriros.internal.statusbar.OuvrirStatusBarItem;

import java.util.ArrayList;

public class OuvrirStatusBarItemHolder extends RelativeLayout
        implements OuvrirStatusBarItem.Manager {
    private static final String TAG = "OuvrirStatusBarItemHolder";

    private ArrayList<OuvrirStatusBarItem.DarkReceiver> mDarkReceivers =
            new ArrayList<OuvrirStatusBarItem.DarkReceiver>();
    private ArrayList<OuvrirStatusBarItem.VisibilityReceiver> mVisibilityReceivers =
            new ArrayList<OuvrirStatusBarItem.VisibilityReceiver>();
    ...
    public OuvrirStatusBarItemHolder(Context context) {
        this(context, null);
    }

    public OuvrirStatusBarItemHolder(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OuvrirStatusBarItemHolder(Context context, AttributeSet attrs, int defStyle) {
    ...
    private DarkReceiver mDarkReceiver = new DarkReceiver() {
        ...
        public void onDarkChanged(Rect area, float darkIntensity, int tint) {
            ...
            mLastTint = tint;
            for (OuvrirStatusBarItem.DarkReceiver r : mDarkReceivers) {
    ...
    private void updateVisibilityReceivers(boolean isVisible) {
        ...
        for (OuvrirStatusBarItem.VisibilityReceiver r : mVisibilityReceivers) {
            r.onVisibilityChanged(mItemHolderIsVisible);
        }
    }

    // OuvrirStatusBarItem.Manager methods

    public void addDarkReceiver(OuvrirStatusBarItem.DarkReceiver darkReceiver) {
    ...
    public void addVisibilityReceiver(OuvrirStatusBarItem.VisibilityReceiver visibilityReceiver) {
