 ...
 *               2017-2018 The OuvrirOS Project
 *
...
public class ProfilesTile extends QSTileImpl<State> {
    ...
    private static final Intent PROFILES_SETTINGS =
            new Intent("org.ouvriros.ouvrirparts.PROFILES_SETTINGS");
    ...
    private void setProfilesEnabled(Boolean enabled) {
        OuvrirSettings.System.putInt(mContext.getContentResolver(),
                OuvrirSettings.System.SYSTEM_PROFILES_ENABLED, enabled ? 1 : 0);
    }
    ...
    public int getMetricsCategory() {
        return OuvrirMetricsLogger.TILE_PROFILES;
    }
        ...
        public void startObserving() {
            mContext.getContentResolver().registerContentObserver(
                    OuvrirSettings.System.getUriFor(
                            OuvrirSettings.System.SYSTEM_PROFILES_ENABLED), false, this);
        }
