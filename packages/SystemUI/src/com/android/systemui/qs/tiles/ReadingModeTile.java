/*
 * Copyright (C) 2018-2020 The OuvrirOS Project
 *
...
import org.ouvriros.internal.util.PackageManagerUtils;
...
public class ReadingModeTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleClick(@Nullable View view) {
        ...
        mHardware.set(OuvrirHardwareManager.FEATURE_READING_ENHANCEMENT, newStatus);
        refreshState();
    }
    ...
    public boolean isAvailable() {
        return mHardware.isSupported(OuvrirHardwareManager.FEATURE_READING_ENHANCEMENT);
    }
    ...
    private boolean isReadingModeEnabled() {
        return mHardware.get(OuvrirHardwareManager.FEATURE_READING_ENHANCEMENT);
    }
}
