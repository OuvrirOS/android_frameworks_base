...
public class RollbackTest {
     ...
     *
     * <p>The rollback capability in the signing ouvrir allows an app to be updated to an APK
     * signed with a previous signing key in the ouvrir; however this often defeats the purpose
